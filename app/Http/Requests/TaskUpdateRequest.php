...
class TaskUpdateRequest extends FormRequest
{
    ...
    public function authorize(): bool
    {
        ...
        // The policy will handle if the user is authorized to update *this specific* task.
        return Auth::check() && $this->user()->can('update', Task::class);
    }
    ...
    public function rules(): array
    {
        return [
            ...
            'status' => ['nullable', 'string', 'in:' . TaskStatus::PENDING . ',' . TaskStatus::COMPLETED], // Use constants
            'file_path' => ['nullable', 'file', 'mimes:jpg,jpeg,png,pdf,doc,docx', 'max:2048'], // Added file validation
            'clear_file' => ['nullable', 'boolean'], // Added for clearing existing file
        ];
    }
